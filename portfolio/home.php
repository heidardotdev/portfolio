...
<header class="header">
    <div class="container">
        <nav class="nav">
            ...
            echo "
                    <a class='menu__link' style='margin-right:4rem;' href='edit.php?Id=$res_id'>Change Profile</a>
            ";
            ?>
                    <a href="logout.php" class="menu__link menu__link--logout">Logout</a>
            </ul>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-7">
                    <div class="home__content">
                        <h3 class="home__name">Hello, IM <span><?php echo $res_Uname ?></span></h3>
                ...
                <div class="col-12 col-lg-5">
                    <div class="home__photo">
                        <img src="img/<?php  echo $fecth['img']  ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
