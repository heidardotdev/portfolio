...
const firstLinkEditTextbox = document.querySelector(
  ".first-link-edit-text-box"
);
...
const secondLinkEditTextbox = document.querySelector(
  ".second-link-edit-text-box"
);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .querySelector(".home-photo-input-box")
